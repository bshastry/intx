...
TEST(uint256, addmod_dao)
{
    ...
    EXPECT_EQ(test::addmod_daosvik(x, y, mod), 0x3bc8be7c7deebfbeffffffd6020000000100_u256);
}

TEST(uint256, addmod_dao2)
{
    ...
    EXPECT_EQ(
        test::addmod_daosvik(x, y, mod), 0x33fffffdfeffe63801ff448281e5fffcfebebf60000021_u256);
}
